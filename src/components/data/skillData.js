		...
		},
		{
			variants: [
				...
				},
				{
					...
					name: "レースプランナー",
					heal: 750,
					conditions: { running_style: 2, distance_rate: [50, 51] },
				},
				{
					rarity: "normal",
					id: 200572,
		...
		},
		{
			variants: [
				...
				},
				{
					...
					id: 109101111,
					holder: 109101,
					name: "天来のリトルシスター", //하늘에서 내려온 리틀 시스터
					targetSpeed: 0.35,
					acceleration: 0.2,
					conditions: {
						distance_type: [2, 3],
			...
			variants: [
				{
					rarity: "rare",
					id: 210321,
					name: "私たちの走る道程", //우리가 달리는 여정
					speedWithDecel: 0.35,
				},
				{
					rarity: "rare",
					id: 210321 - 1,
					name: "私たちの走る道程-1", //우리가 달리는 여정
					speedWithDecel: 0.45,
				},
				{
					rarity: "rare",
					id: 210321 - 2,
					name: "私たちの走る道程-2", //우리가 달리는 여정
					speedWithDecel: 0.55,
				},
				{
					rarity: "normal",
					id: 210322,
					name: "つまでも健やかに", //언제까지나 건강하게
					speedWithDecel: 0.15,
				},
			],
			duration: 2.4,
...
const uniqueSkillData = (thiz) => [
	...
	},
	{
		id: 100541,
		holder: 100541,
		name: "疾風爆走ペガサスダッシュ！", //비코 페가수스
		duration: 4,
		targetSpeed: 0.45,
		conditions: {
			distance_rate: ">=50",
			remain_distance: [149, 151],
			temptation_count: 0,
		},
	},
	{
		...
		invokes: [
			{
				...
				conditions: {
					distance_rate: ">=50",
					ground_type: 2,
					track_id: [10001, 10002, 10003, 10004, 10005, 10006, 10007, 10008, 10009, 10010],
				},
			},
			{
				invokeNo: 2,
				...
				conditions: {
					distance_rate: ">=50",
					ground_type: 2,
					ex_track_id: [10001, 10002, 10003, 10004, 10005, 10006, 10007, 10008, 10009, 10010],
				},
			},
		],
		type: "speed",
	...
	},
	{
		id: 110651,
		holder: 106502,
		name: "ノッてけ、マッシュアップ！", //다이타쿠 헬리오스 (무도회)
		duration: 5,
		invokes: [
			{
				invokeNo: 1,
